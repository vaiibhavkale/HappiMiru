                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    databaseReference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            hashMappp.put("First_Name", firstname);
                                            hashMappp.put("Last_Name", lastname);
                                            hashMappp.put("Mobile_no", mobileno);
                                            hashMappp.put("Passwordc", password);
                                            hashMappp.put("Local_Address", Localaddress);
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            if (task.isSuccessful()) {
                                                                mDialog.dismiss();
                                                                androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(Registeration.this);
