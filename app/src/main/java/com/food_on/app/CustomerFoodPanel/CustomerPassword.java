                                        ...
                                        user.updatePassword(ne).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    FirebaseDatabase.getInstance().getReference("Customer").child(userid).child("Passwordc").setValue(ne);
                                                    FirebaseDatabase.getInstance().getReference("Customer").child(userid).child("Confirm_Password").setValue(conf);
